...
class Product {
  ...
  //Los nombres de los métodos getter y setter usualmente son iguales a las propiedades
...
/* Las propiedades y funciones de los objetos y clases es determinado por sus instancias 
o si son estáticos o si son privados */
...
const prod5 = new Product(3, 'Smartwatch', 300, 12, ['img1', 'img2'], true, 'Huawei');
prod5.sellUnits(10);
prod5.sellUnits(5);
console.log(prod5);
